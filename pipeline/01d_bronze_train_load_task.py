...
df.writeStream.option("path", bronze_train_deltapath).outputMode("append").format("delta").option("checkpointLocation", train_checkpoint_location).option("mergeSchema", "true").table(bronze_table_name)
